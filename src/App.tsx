...
function App() {
  ...
  const scrollToSocialLinks = () => {
    scroller.scrollTo('social-links', {
      duration: 800,
      smooth: true,
      offset: -64,
    });
  ...
  // Sample CV and certificates data (in production, these would be actual file URLs)
  const documents = {
    cv: {
      en: 'https://drive.google.com/file/d/1Tp5npslVOeOFvJWUmIGU8NZeF5TML1I5/view?usp=drivesdk',
      bn: 'https://drive.google.com/file/d/1Tp5npslVOeOFvJWUmIGU8NZeF5TML1I5/view?usp=drivesdk',
    },
    certificates: [
      {
        title: {
      ...
      },
      {
        ...
        issuer: {
          en: 'Through other qualities',
          bn: 'অন্যান্য গুণাবলীর মাধ্যমে',
        },
        date: '2025',
  ...
  const content = {
    ...
    bn: {
      name: 'মো: রিদওয়ান মাহামুদ জিসান',
          ...
          <div className="container mx-auto px-4 py-12">
            <div className="flex flex-col md:flex-row items-center gap-8">
              ...
              <div>
                ...
                >
<motion.a
  href={documents.cv[language]} // CV download link (English/Bangla)
  target="_blank" // Opens in a new tab
  rel="noopener noreferrer" // Security best practice
  download={`Md_Ridoan_Mahmud_Zisan_CV_${language.toUpperCase()}.pdf`} // Optional: Forces download with a filename
  whileHover={{ scale: 1.05 }}
  whileTap={{ scale: 0.95 }}
  className="bg-white text-green-700 px-6 py-2 rounded-md flex items-center gap-2 hover:bg-green-50 cursor-pointer"
>
  <Download size={20} />
  {content[language].downloadCV} {/* Displays "Download CV" or "সিভি ডাউনলোড করুন" */}
</motion.a>
                  <motion.button
                    whileHover={{ scale: 1.05 }}
                    whileTap={{ scale: 0.95 }}
              ...
              <div className="space-y-6">
                ...
                >
                  <h3 className="font-bold text-lg">
                    ...
                    <a
                      href="https://project-all.netlify.app"
                      target="_blank"
                      className="text-blue-600 hover:text-blue-800"
                    >
                      {language === 'en' ? 'View' : 'দেখুন'}
